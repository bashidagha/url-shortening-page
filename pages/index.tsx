...
const Home: NextPage = () => {
  return (
    ...
    <form className="row m-0 w-100 px-5 text-center">
    <div className="col-10 p-0">
    <input type="url" className="form-control" id="input_url" placeholder="Shorten a link here..." required/>
    </div>
    ...
    <h1 className="mb-3">Boost your links today</h1>
    <button className={styles.cstm_btn_large} style={{fontSize:'100%'}}>Get Started</button>
    </div>
    </section>
